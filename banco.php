...
do {
    ...
    switch ($opcao) {
        ...
        case 2:
            ...
            $valorSacar = (float) fgets(STDIN);  //fgets: capturar uma string de um arquivo. O arquivo que estamos tentando acessar não é um arquivo real, mas sim o STDIN.  representa o identificador do nosso terminal, ou seja, a entrada padrão de um processo, que é o nosso terminal
            if ($valorSacar > $saldo) {
